    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SePayWebhooks", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SaleStartDateTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    SaleEndDateTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    xmin = table.Column<uint>(type: "xid", rowVersion: true, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CartReservations_TicketTiers_TicketTierId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QrCodeSignature = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    AttendeeName = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    AttendeeEmail = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    Status = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CartReservations_TicketTierId_ExpiresAt",
                table: "CartReservations",
                columns: new[] { "TicketTierId", "ExpiresAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SePayWebhooks_SePayTransactionId",
                table: "SePayWebhooks",
